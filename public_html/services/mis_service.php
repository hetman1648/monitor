...
//234 - Link Manager Import
//59 - Link Manager Import
//233 - Digital Point Link Allocation
function mis_SEO()
{
	global $cost_year, $cost_month, $db, $db2, $hourly_charge;
	
	$tasks = array();

	$sql  = "SELECT t.task_title, t.task_cost, c.sayu_user_id, t.project_id, td.sayu_domain_id, td.domain_url";
	$sql .= ",t.task_domain_url, t.task_cost, SUM(tr.spent_hours) AS user_spent_hours";
	...
	$sql .= " WHERE (t.project_id=213 OR t.project_id=103 OR t.project_id=224 OR t.project_id=222 OR t.project_id=234  OR t.project_id=59 OR t.project_id=233)";
	...
	{ 
		...
		{	
			...
			switch($project_id_seo){
					case 213: 			$cost_name = "Articles";
										break;
					
					case 103: 			$cost_name = "Articles";
										break;
								
					case 224: 			$cost_name = "Video Distribution";
										break;
								
					case 222: 			$cost_name = "Video Production";
										break;
					
					case 59:
					case 234: 			$cost_name = "Link Manager Import";
										break;
								
					case 233: 			$cost_name = "Digital Point Link Allocation";
										break;
...
function mis_PPC()
{
	...
	$sql .= ", SUM(tr.spent_hours) AS user_spent_hours ";
	...
	{ 
		...
		{	
			...
			switch($project_id_PPC){
					case 59: 	$cost_name = "Paying Client Work";
								break;
								
					case 53: 	$cost_name = "Full Account";
								break;
