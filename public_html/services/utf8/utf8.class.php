...
/*
	# Пример использовения.
	# Создайте объект класса utf8.
	# В конструктор нужно передать ту таблицу символов, которую Вы хотите использовать.
	# По умолчанию вставлено CP1251.

	# Создание класса:
	$oUTF = new new utf8(CP1251);

	# Преобразование из юникода:
	$sStr = $oUTF->utf8ToStr($sUTFStr);

	# Преобразование в юникод:
	$sUTFStr = $oUTF->strToUtf8($sStr);

	# Изменение таблицы символов:
	$oUTF->loadCharset(CP1252);
*/
